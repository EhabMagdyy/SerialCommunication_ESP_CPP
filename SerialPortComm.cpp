...
int main()
{
    ...
    while(1)
    {
        ...
        // Sending data
        std::string dataToSend = "Hello ESP32, How are you?";
        DWORD bytesWritten;
        ...
        std::this_thread::sleep_for(std::chrono::seconds(3));   // delay 3 second
        char buffer[256];
        DWORD bytesRead;
        ...
        else{ std::cout << "Sending & Receiving loop ends" << std::endl << std::endl; }
    }
